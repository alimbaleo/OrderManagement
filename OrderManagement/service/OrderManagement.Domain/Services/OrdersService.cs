...
namespace OrderManagement.Domain.Services
{
    public class OrdersService : IOrdersService
    {
        ...
        public async Task<Order> RegisterOrder(string createdBy, string product, string orderNo, decimal price, decimal total, DateTime orderDate)
        {
            ValidatePrice(price, total, total);
            ...
            var order = new Order(createdBy, product, orderNo, price, total, total, orderDate);
