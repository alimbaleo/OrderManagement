...
namespace OrderManagement.Api.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetList")]
        public async Task<ActionResult<ResponseDto<List<OrdersDto>>>> GetList()
        {
            ResponseDto<List<OrdersDto>> result = await _orderAppService.GetOrders();
            return StatusCode(result.ResponseCode, result);
        }

        [HttpPost]
        [Route("Register")]
        public async Task<ActionResult<ResponseDto<OrdersDto>>> Register([FromBody]CreateOrderDto input)
        {
